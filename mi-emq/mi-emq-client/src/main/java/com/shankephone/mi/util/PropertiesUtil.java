...
public class PropertiesUtil
{
    ...
    static {
        ...
        MQTT_SERVER_DEFAULT_TOPIC = loadMqttProperties().getProperty("MQTT_SERVER_DEFAULT_TOPIC");
        MQTT_PRODUCT_CLIENTID = loadMqttProperties().getProperty("MQTT_PRODUCT_CLIENTID");
