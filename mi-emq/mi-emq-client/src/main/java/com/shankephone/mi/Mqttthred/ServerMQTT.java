package com.shankephone.mi.Mqttthred;
...
public class ServerMQTT {  
    ...
    public static final String HOST = "tcp://testmqtt.shankephone.com:1883";  
    //定义一个主题  
    public static final String TOPIC = PropertiesUtil.MQTT_SERVER_DEFAULT_TOPIC;
    ...
    private String passWord = "!QAZxcvfr432";  //非必须
...
//        server.message.setPayload("2018-10-11-018".getBytes());
