Ext.define('App.addMaintenanceApply.addMaintenanceApplyView', {
    extend: 'Ext.grid.Panel',
    requires: [
        'App.addMaintenanceApply.addMaintenanceApplyStore',
        'App.addMaintenanceApply.addMaintenanceApplyController',
        'App.addMaintenanceApply.addMaintenanceApplyWindow',
        'App.addMaintenanceApply.addMaintenanceApplyStationWindow',
    ...
    store: {
        xclass: 'App.addMaintenanceApply.addMaintenanceApplyStore'
    },
    controller: {
        xclass: 'App.addMaintenanceApply.addMaintenanceApplyController'
    },
    xtype: 'addMaintenanceApplyView',
    fullscreen: true,
    tbar: [
        {
            id: 'addMaintenanceApplyViewFormId',
            xtype: 'form',
            fullscreen: true,
            width: 1100,
            items: [
