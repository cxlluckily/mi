Ext.define('App.server.serverEquipmentStore', {
    ...
    listeners: {
        beforeload: function (store, options) {
            var formValues = Ext.getCmp('serverEquipmentGridFormId').getForm().getValues();
...
Ext.define('App.server.serverEquipmentGrid', {
    extend: 'Ext.grid.Panel',
    store: {
        xclass: 'App.server.serverEquipmentStore'
    },
    xtype: 'serverEquipmentGrid',
    fullscreen: true,
    height:500,
    tbar: [
        {
            id: 'serverEquipmentGridFormId',
            xtype: 'form',
            fullscreen: true,
            width: 1200,
            items: [
                                            ...
                                            load: function (store, records, successful, operation, eOpts) {
                                                if (store.includeAll) {
                                                    if (records.length > 0) {
                                                        ...
                                                        Ext.ComponentQuery.query('serverView')[0].down('combo[name="stationId"]').setValue('-1');
                                                    }
                                                }
                                            }
                                        }
...
Ext.define('App.server.serverWindow', {
