Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyLookGrid', {
    extend: 'Ext.grid.Panel',
    requires: [],
    store: {},
    xtype: 'stockBusinessUseApplyLookGrid',
    fullscreen: true,
    height: 250,
    style: {
...
Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyLookInfoListGrid', {
    extend: 'Ext.grid.Panel',
    requires: [],
    store: {},
    xtype: 'stockBusinessUseApplyLookInfoListGrid',
    fullscreen: true,
    hideHeaders: true,
    // height: 250,
    style: {
...
Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyLookForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    layout: 'column',
    buttonAlign: 'center',
    width: '100%',
    xtype: 'stockBusinessUseApplyLookForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 70,
...
Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyLookWindow', {
    ...
    autoRender: true,
    buttonAlign: "center",
    xtype: 'stockBusinessUseApplyLookWindow',
