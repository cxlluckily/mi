Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyDetailGrid',{
    ...
    store: {},
    xtype: 'stockBusinessUseApplyDetailGrid',
    fullscreen: true,
    height: 300,
    style: {
...
Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyDetailForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    layout: 'column',
    buttonAlign: 'center',
    width: '100%',
    xtype: 'stockBusinessUseApplyDetailForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 70,
...
Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyDetailWindow', {
    ...
    autoRender: true,
    buttonAlign: "center",
    xtype: 'stockBusinessUseApplyDetailWindow',
