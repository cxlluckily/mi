Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyModel', {
...
Ext.define('App.stockBusinessUseApply.stockBusinessUseApplyStore', {
    extend: 'App.common.commonStore',
    model: "App.stockBusinessUseApply.stockBusinessUseApplyModel",//字段限定类型，需要新增行数据时使用
    proxy: {
