Ext.define('App.maintenanceApplyRepair.maintenanceApplyRepairForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    buttonAlign: 'center',
    width: '100%',
    padding:10,
    xtype: 'maintenanceApplyRepairForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 100,
            ...
            items: [
                {
                    ...
                    items: [
                        {
                            xtype: 'maintenanceApplyRepairGrid'
                        }
                    ]
                }
            ]
...
Ext.define('App.maintenanceApplyRepair.maintenanceApplyRepairGrid', {
...
Ext.define('App.maintenanceApplyRepair.maintenanceApplyRepairWindow', {
    ...
    buttonAlign: "center",
    xtype: 'maintenanceApplyRepairWindow',
