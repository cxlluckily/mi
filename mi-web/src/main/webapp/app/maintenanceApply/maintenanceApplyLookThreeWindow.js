Ext.define('App.maintenanceApply.maintenanceApplyLookThreeForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    buttonAlign: 'center',
    width: '100%',
    padding: 10,
    xtype: 'maintenanceApplyLookThreeForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 100,
...
Ext.define('App.maintenanceApply.maintenanceApplyLookThreeWindow', {
    ...
    buttonAlign: "center",
    xtype: 'maintenanceApplyLookThreeWindow',
