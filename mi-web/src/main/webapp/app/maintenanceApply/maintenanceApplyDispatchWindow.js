Ext.define('App.maintenanceApply.maintenanceApplyDispatchForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    buttonAlign: 'center',
    width: '100%',
    padding: 10,
    xtype: 'maintenanceApplyDispatchForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 100,
                        ...
                        },
                        {
                            ...
                            listeners: {
                                beforerender: function (component) {
                                    var formValues = component.up('maintenanceApplyDispatchForm').getForm().getValues();
                                ...
                                change:function (component, newValue, oldValue, eOpts) {
                                    ...
                                    component.up('maintenanceApplyDispatchForm').getForm().setValues({maintenanceUser:displayValue});
                                }
                            }
                        },
                        {
...
Ext.define('App.maintenanceApply.maintenanceApplyDispatchWindow', {
    ...
    buttonAlign: "center",
    xtype: 'maintenanceApplyDispatchWindow',
