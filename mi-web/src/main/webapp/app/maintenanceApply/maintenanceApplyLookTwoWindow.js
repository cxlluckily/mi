Ext.define('App.maintenanceApply.maintenanceApplyLookTwoForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    buttonAlign: 'center',
    width: '100%',
    padding: 10,
    xtype: 'maintenanceApplyLookTwoForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 100,
...
Ext.define('App.maintenanceApply.maintenanceApplyLookTwoWindow', {
    ...
    buttonAlign: "center",
    xtype: 'maintenanceApplyLookTwoWindow',
