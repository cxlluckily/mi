Ext.define('App.maintenanceApply.maintenanceApplyLookFourForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    buttonAlign: 'center',
    width: '100%',
    padding: 10,
    xtype: 'maintenanceApplyLookFourForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 100,
...
Ext.define('App.maintenanceApply.maintenanceApplyLookFourWindow', {
    ...
    buttonAlign: "center",
    xtype: 'maintenanceApplyLookFourWindow',
