Ext.define('App.stockOutStockApply.stockOutStockApplyBorrowSelectAddForm', {
    extend: 'Ext.form.Panel',
    fullscreen: true,
    layout: 'column',
    buttonAlign: 'center',
    width: '100%',
    xtype: 'stockOutStockApplyBorrowSelectAddForm',
    fieldDefaults: {
        anchor: '100%',
        labelAlign: 'right',
        labelWidth: 70,
...
Ext.define('App.stockOutStockApply.stockOutStockApplyBorrowSelectAddWindow', {
    ...
    autoRender: true,
    buttonAlign: "center",
    xtype: 'stockOutStockApplyBorrowSelectAddWindow',
