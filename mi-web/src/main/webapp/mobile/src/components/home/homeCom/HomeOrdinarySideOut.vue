<template>
  <div id='HomeOrdinarySideOut' v-show="switchCurrentCom">
      ...
      <transition name="slide-fade" v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:after-leave="afterLeave">
        <div class="main-right clearfix" v-show="switchHomeOrdinarySideOut">
          ...
          <div class="right-type" ref='typeScroll'>
            <ul>
              <li v-for="itemType in ordinarySideOutData" :key="itemType.sideOutId" :data-sideOutId="itemType.sideOutId" @click="selectedType($event)">
                <p>{{itemType.sideOutText}}</p>
              </li>
            </ul>
