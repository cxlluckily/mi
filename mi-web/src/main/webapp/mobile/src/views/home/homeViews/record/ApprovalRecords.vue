<template>
  <div id='ApprovalRecords'>
    ...
    <div class="ApprovalRecords-main">
    ...
    <Search :switchHomeSearch="isSearchCom" :switchStatus='childStaus' :switchHomeSearchApplyType="true" @switchSearchCom=getSwitchSearchCom @SearchData="SearchCom">
    </Search>
