<template>
  <div id='MaintenanceRecord'>
    <HomeRecordTitle :swtichInventorySearch="childswtichInventorySearch" @timerDeta='getTimerDeta'>
    </HomeRecordTitle>
    <div class="MaintenanceRecord-main">
...
<script>
  ...
  import HomeRecordTitle from "@/components/home/homeCom/HomeRecordTitle";
  export default {
    ...
    data() {
      return {
        ...
        REParamObj: {
          ...
          start: 0,
          limit: 5,
          beginTime: this.common.getDate('yyyy-MM-dd', -60) + ' 00:00:00',
          endTime: this.common.getDate('yyyy-MM-dd')+ ' 23:59:59',
        },
        totalCount: ""
      };
    },
    methods: {
      ...
      issuedLoad() {
        ...
        this.REParamObj.start = this.childTicketNumberData.length;
        this.initData({
          val: this.REParamObj,
          initLoaded: true
        });
      ...
      initData({
        ...
        this.api.dispatchingRecordDataAll(val).then((data) => {
          ...
          for (let i = 0, L = data.data.rows.length; i < L; i++) {
            this.childTicketNumberData.push({
              ...
              childRouterUrl: "/MaintenanceRecordDetails/" + DATA[i].maintenanceApplyId,
              currentComponent: "/MaintenanceRecord",
      ...
      getTimerDeta(val){
        this.swtichLoading = true;
        if (val.beginTime != '') {
          this.REParamObj.beginTime = val.beginTime + ' 00:00:00';
        }
        if (val.endTime != '') {
          this.REParamObj.endTime = val.endTime + ' 23:59:59';
        }
        this.REParamObj.applyNO = val.applyNO;
...
<style lang='scss'>
  ...
  #MaintenanceRecord {
    ...
    .gloobalEmptyPrompt {
      ...
      padding-top: 66px;
      box-sizing: border-box; // .emptyPrompt {
      //   background: url("../../../../assets/home/nosubject.png");
      //   background-size: 100% 100%;
      // }
    }
    .MaintenanceRecord-main {
