<template>
  <div id="EditInventoryInfo">
    ...
    <div class="footer">
      <button class="end_btn" @click="AddInformation">修改</button>
    ...
    methods: {
      AddInformation(PostData) {
        ...
        if (beginTIme == '') {
          ...
          this.requests.inventoryTaskUpdate(this.PostData).then(function (respont) {
      ...
      getInventoryDetailEntity() {
        ...
        this.requests.getInventoryDetailEntity(taskIds).then(function (respont) {
          if (respont.result == 'success') {
            console.log(respont);
            _this.PostData = respont.data;
            _this.PostData.beginTIme = _this.common.getDate('yyyy-MM-dd', 0, new Date(respont.data.beginTIme));
            _this.PostData.endTIme = _this.common.getDate('yyyy-MM-dd', 0, new Date(respont.data.endTIme));
            _this.PostData.userKey = _this.common.getLocalStorage('userKey');
          } else {
