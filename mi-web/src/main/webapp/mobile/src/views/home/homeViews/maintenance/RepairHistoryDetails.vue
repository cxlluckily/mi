<template>
  <div id='RepairHistoryDetails'>
    <div class="RepairHistoryDetails-main">
      <div class="RepairHistoryDetails-site">
        <GlobalTroubleNumber :ticketNumberData="childTicketNumberData">
        </GlobalTroubleNumber>
      </div>
      <div class="RepairHistoryDetails-process">
        <HomeProcess :processData="childProcessData"></HomeProcess>
      </div>
      <div class="RepairHistoryDetails-fault">
...
<style lang='scss'>
  ...
  #RepairHistoryDetails {
    ...
    .RepairHistoryDetails-main {
      width: 100%;
      height: calc(100% - 70px);
      overflow: hidden;
      overflow-y: auto;
    }
    .RepairHistoryDetails-fault {
      margin: 20px 0;
    }
    .evaluationWin {
      position: absolute;
