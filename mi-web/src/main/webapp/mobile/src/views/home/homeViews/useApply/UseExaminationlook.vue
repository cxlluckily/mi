      ...
      initData() {
        ...
        this.requests.getApplyInfoByApplyId(PROMPOBJ).then((data) => {
          ...
          this.detailsData.push({
            ...
            title: '入库仓库',
            text: DATA.inWareHouseName || '暂无数据!'
          }, {
            title: '申请人',
          ...
          switch (this.detailsData[4].text) {
            case 'borrow':
              this.detailsData[4].text = '借用申请';
              this.listingTitle = '借用清单';
              break;
            case 'return':
              this.detailsData[4].text = '返还申请';
              this.listingTitle = '返还清单';
              break;
            case 'use':
              this.detailsData[4].text = '领用申请';
              this.listingTitle = '领用清单';
              break;
            case 'transfer':
              this.detailsData[4].text = '调拨申请';
              this.listingTitle = '调拨清单';
              break;
          }
          switch (this.detailsData[6].text) {
            case 'toBeIn':
              this.detailsData[6].text = '待归还';
              break;
            case 'toBeReview':
              this.detailsData[6].text = '待审核';
              break;
            case 'reviewPass':
              this.detailsData[6].text = '审核通过';
              break;
            case 'reviewNoPass':
              this.detailsData[6].text = '审核不通过';
              break;
            case 'over':
              this.detailsData[6].text = '已完成';
              break;
            case 'toBeOut':
              this.detailsData[6].text = '待出库';
              break;
          }
