<template>
    <div id='LingDaoFanRecords'>
        <div class="fault-btn">
            <button @click="searchSubmit">查询</button>
        </div>
        <div class="LingDaoFanRecords-main">
        ...
        <!--</div>-->
        <!--侧边栏右滑-->
        <Search :switchHomeSearch="isSearchCom" :switchStatus='childStaus' @switchSearchCom=getSwitchSearchCom @SearchData="SearchCom">
        </Search>
    ...
    export default {
        ...
        methods: {
            ...
            addbtnStorage(type, item) {
                let applyType = this.$route.params.type;
            ...
            issuedLoad() {
                ...
                this.requests.requisitionRecordInfor(this.paramsObj).then(respont => {
            ...
            SearchCom(val) {
                ...
                const _this = this;
                const applyType = this.$route.params.type;
                this.paramsObj = {
                    userKey: USERKEY,
                    applyStatus: val.status,
                    applyType: applyType,
                    notApplyStatus:"toBeReview",
